...
function twoNum(arr) {
    arr.forEach(element => {
        for (i = arr.indexOf(element); i<arr.length; i++) {
            if (element + arr[i] === 2020 ) {
                num1 = element;
                num2 = arr[i];
            }
        }
...
function threeNum(arr) {
    arr.forEach(element => {
        for (i = arr.indexOf(element); i<arr.length; i++) {
            for (j = arr.indexOf(i); j<arr.length; j++) 
            if (element + arr[i] + arr[j] === 2020 ) {
                num3 = element;
                num4 = arr[i];
                num5 = arr[j];
            }
